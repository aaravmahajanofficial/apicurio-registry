...
CREATE TABLE webhook_fanout (outboxEventId VARCHAR(128) NOT NULL, sourcePayload JSON NOT NULL, storageEventType VARCHAR(64) NOT NULL, fanoutStatus VARCHAR(32) NOT NULL DEFAULT 'PENDING', fanoutAttempts INT NOT NULL DEFAULT 0, lastError TEXT, createdOn TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, fanoutOn TIMESTAMP);
...
CREATE TABLE webhook_deliveries (deliveryId BIGINT AUTO_INCREMENT NOT NULL, subscriptionId VARCHAR(36) NOT NULL, cloudEventId VARCHAR(36) NOT NULL, eventType VARCHAR(128) NOT NULL, payload JSON NOT NULL, status VARCHAR(32) NOT NULL DEFAULT 'PENDING', attemptCount INT NOT NULL DEFAULT 0, nextAttemptOn TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, lastError TEXT, createdOn TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, modifiedOn TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP);
...
CREATE TABLE webhook_delivery_log (logId BIGINT AUTO_INCREMENT NOT NULL, deliveryId BIGINT NOT NULL, subscriptionId VARCHAR(36) NOT NULL, cloudEventId VARCHAR(36) NOT NULL, attemptNumber INT NOT NULL, httpStatus INT, durationMs INT, error TEXT, attemptedOn TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP);
